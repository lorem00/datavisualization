...
export const GET_DISCOVERY_CATEGORY_CONTROL = 'GET_DISCOVERY_CATEGORY_CONTROL';
...
function getDiscoveryCategoryCountsApi( data, callback ) {
    ...
    axios.post(rest.GET_DEVICE_CATEGORY_CONTROL, data, options)
        .then((response) => {
            ...
            return callback(new Error('Could not get All Discovery Category Controls', error));
        });
}
